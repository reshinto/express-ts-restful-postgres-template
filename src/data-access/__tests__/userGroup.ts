...
describe("addUsersToGroupInDb", () => {
  ...
  it("should return user group", async () => {
    const userId = "7f4c416f-9842-43dd-935f-8c697f448046";
    const groupId = "92c3f76f-43ed-44f8-90db-3dbb7cd6762e";
    const expected = [{ user_id: userId, group_id: groupId }];
    jest.spyOn(UserGroup, "bulkCreate").mockResolvedValue(expected as any);
    const result = await addUsersToGroupInDb(groupId, [userId]);
